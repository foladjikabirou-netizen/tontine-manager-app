    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-primary-800 mt-4">Tontine Famille</h1>
          <p className="text-gray-500 mt-2">Gérez votre tontine familiale en toute simplicité.</p>
        </div>
